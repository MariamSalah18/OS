...
//	cprintf("envID = %d\n",envID);
  ...
  8000de:	68 d4 1c 80 00       	push   $0x801cd4
  ...
  800108:	68 10 1d 80 00       	push   $0x801d10
  ...
  80011c:	68 74 1d 80 00       	push   $0x801d74
...
libmain(int argc, char **argv)
{
  ...
  8001c0:	52                   	push   %edx
  8001c1:	50                   	push   %eax
  8001c2:	68 fc 1d 80 00       	push   $0x801dfc
  ...
  8001f1:	52                   	push   %edx
  8001f2:	50                   	push   %eax
  8001f3:	68 24 1e 80 00       	push   $0x801e24
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80027d:	50                   	push   %eax
  80027e:	68 90 1e 80 00       	push   $0x801e90
  ...
  800296:	50                   	push   %eax
  800297:	68 95 1e 80 00       	push   $0x801e95
  ...
  8002bb:	68 b1 1e 80 00       	push   $0x801eb1
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8002ea:	68 b4 1e 80 00       	push   $0x801eb4
  8002ef:	6a 26                	push   $0x26
  8002f1:	68 00 1f 80 00       	push   $0x801f00
  ...
  8003bf:	68 0c 1f 80 00       	push   $0x801f0c
  8003c4:	6a 3a                	push   $0x3a
  8003c6:	68 00 1f 80 00       	push   $0x801f00
  ...
  800432:	68 60 1f 80 00       	push   $0x801f60
  800437:	6a 44                	push   $0x44
  800439:	68 00 1f 80 00       	push   $0x801f00
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8005b7:	e8 0c 14 00 00       	call   8019c8 <__udivdi3>
  ...
  800605:	52                   	push   %edx
  800606:	50                   	push   %eax
  800607:	e8 cc 14 00 00       	call   801ad8 <__umoddi3>
  80060c:	83 c4 10             	add    $0x10,%esp
  80060f:	05 d4 21 80 00       	add    $0x8021d4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800762:	8b 04 85 f8 21 80 00 	mov    0x8021f8(,%eax,4),%eax
  ...
  800843:	8b 34 9d 40 20 80 00 	mov    0x802040(,%ebx,4),%esi
  80084a:	85 f6                	test   %esi,%esi
  80084c:	75 19                	jne    800867 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80084e:	53                   	push   %ebx
  80084f:	68 e5 21 80 00       	push   $0x8021e5
  ...
  800862:	e9 49 02 00 00       	jmp    800ab0 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800867:	56                   	push   %esi
  800868:	68 ee 21 80 00       	push   $0x8021ee
  ...
  800893:	75 05                	jne    80089a <vprintfmt+0x1a6>
				p = "(null)";
  800895:	be f1 21 80 00       	mov    $0x8021f1,%esi
			if (width > 0 && padc != '-')
