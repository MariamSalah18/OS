...
libmain(int argc, char **argv)
{
  ...
  800101:	68 f8 19 80 00       	push   $0x8019f8
  ...
  800127:	52                   	push   %edx
  800128:	50                   	push   %eax
  800129:	68 20 1a 80 00       	push   $0x801a20
  ...
  800158:	52                   	push   %edx
  800159:	50                   	push   %eax
  80015a:	68 48 1a 80 00       	push   $0x801a48
  ...
  800186:	68 f8 19 80 00       	push   $0x8019f8
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800335:	e8 0e 14 00 00       	call   801748 <__udivdi3>
  ...
  800383:	52                   	push   %edx
  800384:	50                   	push   %eax
  800385:	e8 ce 14 00 00       	call   801858 <__umoddi3>
  80038a:	83 c4 10             	add    $0x10,%esp
  80038d:	05 d4 1c 80 00       	add    $0x801cd4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004e0:	8b 04 85 f8 1c 80 00 	mov    0x801cf8(,%eax,4),%eax
  ...
  8005c1:	8b 34 9d 40 1b 80 00 	mov    0x801b40(,%ebx,4),%esi
  8005c8:	85 f6                	test   %esi,%esi
  8005ca:	75 19                	jne    8005e5 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  8005cc:	53                   	push   %ebx
  8005cd:	68 e5 1c 80 00       	push   $0x801ce5
  ...
  8005e0:	e9 49 02 00 00       	jmp    80082e <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8005e5:	56                   	push   %esi
  8005e6:	68 ee 1c 80 00       	push   $0x801cee
  ...
  800611:	75 05                	jne    800618 <vprintfmt+0x1a6>
				p = "(null)";
  800613:	be f1 1c 80 00       	mov    $0x801cf1,%esi
			if (width > 0 && padc != '-')
