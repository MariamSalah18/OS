...
libmain(int argc, char **argv)
{
  ...
  80014c:	68 ec 1c 80 00       	push   $0x801cec
  ...
  800172:	52                   	push   %edx
  800173:	50                   	push   %eax
  800174:	68 14 1d 80 00       	push   $0x801d14
  ...
  8001a3:	52                   	push   %edx
  8001a4:	50                   	push   %eax
  8001a5:	68 3c 1d 80 00       	push   $0x801d3c
  ...
  8001c0:	50                   	push   %eax
  8001c1:	68 94 1d 80 00       	push   $0x801d94
  8001c6:	e8 18 01 00 00       	call   8002e3 <cprintf>
  8001cb:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  8001ce:	83 ec 0c             	sub    $0xc,%esp
  8001d1:	68 ec 1c 80 00       	push   $0x801cec
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800380:	e8 b3 16 00 00       	call   801a38 <__udivdi3>
  ...
  8003ce:	52                   	push   %edx
  8003cf:	50                   	push   %eax
  8003d0:	e8 73 17 00 00       	call   801b48 <__umoddi3>
  8003d5:	83 c4 10             	add    $0x10,%esp
  8003d8:	05 d4 1f 80 00       	add    $0x801fd4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80052b:	8b 04 85 f8 1f 80 00 	mov    0x801ff8(,%eax,4),%eax
  ...
  80060c:	8b 34 9d 40 1e 80 00 	mov    0x801e40(,%ebx,4),%esi
  800613:	85 f6                	test   %esi,%esi
  800615:	75 19                	jne    800630 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800617:	53                   	push   %ebx
  800618:	68 e5 1f 80 00       	push   $0x801fe5
  ...
  80062b:	e9 49 02 00 00       	jmp    800879 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800630:	56                   	push   %esi
  800631:	68 ee 1f 80 00       	push   $0x801fee
  ...
  80065c:	75 05                	jne    800663 <vprintfmt+0x1a6>
				p = "(null)";
  80065e:	be f1 1f 80 00       	mov    $0x801ff1,%esi
			if (width > 0 && padc != '-')
...
void readline(const char *prompt, char* buf)
{
  ...
  800977:	68 50 21 80 00       	push   $0x802150
  ...
  800990:	e8 98 10 00 00       	call   801a2d <iscons>
  800995:	83 c4 10             	add    $0x10,%esp
  800998:	89 45 f0             	mov    %eax,-0x10(%ebp)
	while (1) {
		c = getchar();
  80099b:	e8 3f 10 00 00       	call   8019df <getchar>
  ...
  8009b9:	68 53 21 80 00       	push   $0x802153
  ...
  8009e6:	e8 ac 0f 00 00       	call   801997 <cputchar>
  ...
  800a1d:	e8 75 0f 00 00       	call   801997 <cputchar>
  ...
  800a46:	e8 4c 0f 00 00       	call   801997 <cputchar>
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  800a7a:	68 50 21 80 00       	push   $0x802150
  ...
  800a93:	e8 95 0f 00 00       	call   801a2d <iscons>
  800a98:	83 c4 10             	add    $0x10,%esp
  800a9b:	89 45 f0             	mov    %eax,-0x10(%ebp)
	while (1) {
		c = getchar();
  800a9e:	e8 3c 0f 00 00       	call   8019df <getchar>
  ...
  800ab8:	68 53 21 80 00       	push   $0x802153
  ...
  800aea:	e8 a8 0e 00 00       	call   801997 <cputchar>
  ...
  800b21:	e8 71 0e 00 00       	call   801997 <cputchar>
  ...
  800b4a:	e8 48 0e 00 00       	call   801997 <cputchar>
...
cputchar(int ch)
{
  ...
  8019a0:	88 45 f7             	mov    %al,-0x9(%ebp)
	...
	sys_cputc(c);
  8019a3:	0f be 45 f7          	movsbl -0x9(%ebp),%eax
  8019a7:	83 ec 0c             	sub    $0xc,%esp
  8019aa:	50                   	push   %eax
  8019ab:	e8 ed fa ff ff       	call   80149d <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  8019b9:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8019bc:	e8 a8 fa ff ff       	call   801469 <sys_disable_interrupt>
	char c = ch;
  8019c1:	8b 45 08             	mov    0x8(%ebp),%eax
  8019c4:	88 45 f7             	mov    %al,-0x9(%ebp)
	...
	sys_cputc(c);
  8019c7:	0f be 45 f7          	movsbl -0x9(%ebp),%eax
  8019cb:	83 ec 0c             	sub    $0xc,%esp
  8019ce:	50                   	push   %eax
  8019cf:	e8 c9 fa ff ff       	call   80149d <sys_cputc>
  8019d4:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8019d7:	e8 a7 fa ff ff       	call   801483 <sys_enable_interrupt>
}
  8019dc:	90                   	nop
  8019dd:	c9                   	leave  
  8019de:	c3                   	ret    
...
getchar(void)
{
  ...
  8019e5:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	while(c == 0)
  8019ec:	eb 08                	jmp    8019f6 <getchar+0x17>
	{
		c = sys_cgetc();
  8019ee:	e8 46 f9 ff ff       	call   801339 <sys_cgetc>
...
getchar(void)
{
	...
	int c=0;
	while(c == 0)
  8019f6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  8019fa:	74 f2                	je     8019ee <getchar+0xf>
	{
		c = sys_cgetc();
	}
	return c;
...
atomic_getchar(void)
{
  ...
  801a04:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  801a07:	e8 5d fa ff ff       	call   801469 <sys_disable_interrupt>
	int c=0;
  801a0c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	while(c == 0)
  801a13:	eb 08                	jmp    801a1d <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  801a15:	e8 1f f9 ff ff       	call   801339 <sys_cgetc>
...
atomic_getchar(void)
{
	...
	int c=0;
	while(c == 0)
  801a1d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801a21:	74 f2                	je     801a15 <atomic_getchar+0x14>
	{
		c = sys_cgetc();
	}
	sys_enable_interrupt();
  801a23:	e8 5b fa ff ff       	call   801483 <sys_enable_interrupt>
	return c;
