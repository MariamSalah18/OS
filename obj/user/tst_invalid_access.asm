...
void _main(void)
{
  ...
  800137:	e8 95 17 00 00       	call   8018d1 <env_sleep>
  ...
  8001db:	e8 f1 16 00 00       	call   8018d1 <env_sleep>
...
libmain(int argc, char **argv)
{
  ...
  80028c:	68 38 1e 80 00       	push   $0x801e38
  ...
  8002e3:	52                   	push   %edx
  8002e4:	50                   	push   %eax
  8002e5:	68 88 1e 80 00       	push   $0x801e88
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004c0:	e8 c3 14 00 00       	call   801988 <__udivdi3>
  ...
  80050e:	52                   	push   %edx
  80050f:	50                   	push   %eax
  800510:	e8 83 15 00 00       	call   801a98 <__umoddi3>
  800515:	83 c4 10             	add    $0x10,%esp
  800518:	05 14 21 80 00       	add    $0x802114,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80066b:	8b 04 85 38 21 80 00 	mov    0x802138(,%eax,4),%eax
  ...
  80074c:	8b 34 9d 80 1f 80 00 	mov    0x801f80(,%ebx,4),%esi
  800753:	85 f6                	test   %esi,%esi
  800755:	75 19                	jne    800770 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800757:	53                   	push   %ebx
  800758:	68 25 21 80 00       	push   $0x802125
  ...
  80076b:	e9 49 02 00 00       	jmp    8009b9 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800770:	56                   	push   %esi
  800771:	68 2e 21 80 00       	push   $0x80212e
  ...
  80079c:	75 05                	jne    8007a3 <vprintfmt+0x1a6>
				p = "(null)";
  80079e:	be 31 21 80 00       	mov    $0x802131,%esi
			if (width > 0 && padc != '-')
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801902:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	struct uint64 baseTime = sys_get_virtual_time() ;
  801909:	8d 45 e8             	lea    -0x18(%ebp),%eax
  80190c:	83 ec 0c             	sub    $0xc,%esp
  80190f:	50                   	push   %eax
  801910:	e8 cd fc ff ff       	call   8015e2 <sys_get_virtual_time>
  801915:	83 c4 0c             	add    $0xc,%esp
	while(cycles_counter<time_in_cycles)
  801918:	eb 41                	jmp    80195b <env_sleep+0x8a>
	{
		struct uint64 currentTime = sys_get_virtual_time() ;
  80191a:	8d 45 e0             	lea    -0x20(%ebp),%eax
  80191d:	83 ec 0c             	sub    $0xc,%esp
  801920:	50                   	push   %eax
  801921:	e8 bc fc ff ff       	call   8015e2 <sys_get_virtual_time>
  ...
  801929:	8b 55 e0             	mov    -0x20(%ebp),%edx
  80192c:	8b 45 e8             	mov    -0x18(%ebp),%eax
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801961:	72 b7                	jb     80191a <env_sleep+0x49>
//				,cycles_counter
//				);
	}
...
uint32 busy_wait(uint32 loopMax)
{
  ...
  801969:	83 ec 10             	sub    $0x10,%esp
	uint32 i = 0 ;
  80196c:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
	while (i < loopMax) i++;
  801973:	eb 03                	jmp    801978 <busy_wait+0x12>
  801975:	ff 45 fc             	incl   -0x4(%ebp)
  801978:	8b 45 fc             	mov    -0x4(%ebp),%eax
  80197b:	3b 45 08             	cmp    0x8(%ebp),%eax
  80197e:	72 f5                	jb     801975 <busy_wait+0xf>
	return i;
