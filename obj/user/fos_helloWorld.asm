...
libmain(int argc, char **argv)
{
  ...
  8000d2:	68 d4 19 80 00       	push   $0x8019d4
  ...
  8000f8:	52                   	push   %edx
  8000f9:	50                   	push   %eax
  8000fa:	68 fc 19 80 00       	push   $0x8019fc
  ...
  800129:	52                   	push   %edx
  80012a:	50                   	push   %eax
  80012b:	68 24 1a 80 00       	push   $0x801a24
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800306:	e8 0d 14 00 00       	call   801718 <__udivdi3>
  ...
  800354:	52                   	push   %edx
  800355:	50                   	push   %eax
  800356:	e8 cd 14 00 00       	call   801828 <__umoddi3>
  80035b:	83 c4 10             	add    $0x10,%esp
  80035e:	05 b4 1c 80 00       	add    $0x801cb4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004b1:	8b 04 85 d8 1c 80 00 	mov    0x801cd8(,%eax,4),%eax
  ...
  800592:	8b 34 9d 20 1b 80 00 	mov    0x801b20(,%ebx,4),%esi
  800599:	85 f6                	test   %esi,%esi
  80059b:	75 19                	jne    8005b6 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80059d:	53                   	push   %ebx
  80059e:	68 c5 1c 80 00       	push   $0x801cc5
  ...
  8005b1:	e9 49 02 00 00       	jmp    8007ff <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8005b6:	56                   	push   %esi
  8005b7:	68 ce 1c 80 00       	push   $0x801cce
  ...
  8005e2:	75 05                	jne    8005e9 <vprintfmt+0x1a6>
				p = "(null)";
  8005e4:	be d1 1c 80 00       	mov    $0x801cd1,%esi
			if (width > 0 && padc != '-')
