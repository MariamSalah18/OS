	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80036a:	e8 b5 16 00 00       	call   801a24 <__udivdi3>
  ...
  8003b8:	52                   	push   %edx
  8003b9:	50                   	push   %eax
  8003ba:	e8 75 17 00 00       	call   801b34 <__umoddi3>
...
void readline(const char *prompt, char* buf)
{
  ...
  80097a:	e8 98 10 00 00       	call   801a17 <iscons>
  80097f:	83 c4 10             	add    $0x10,%esp
  800982:	89 45 f0             	mov    %eax,-0x10(%ebp)
	while (1) {
		c = getchar();
  800985:	e8 3f 10 00 00       	call   8019c9 <getchar>
  ...
  8009d0:	e8 ac 0f 00 00       	call   801981 <cputchar>
  ...
  800a07:	e8 75 0f 00 00       	call   801981 <cputchar>
  ...
  800a30:	e8 4c 0f 00 00       	call   801981 <cputchar>
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  800a7d:	e8 95 0f 00 00       	call   801a17 <iscons>
  800a82:	83 c4 10             	add    $0x10,%esp
  800a85:	89 45 f0             	mov    %eax,-0x10(%ebp)
	while (1) {
		c = getchar();
  800a88:	e8 3c 0f 00 00       	call   8019c9 <getchar>
  ...
  800ad4:	e8 a8 0e 00 00       	call   801981 <cputchar>
  ...
  800b0b:	e8 71 0e 00 00       	call   801981 <cputchar>
  ...
  800b34:	e8 48 0e 00 00       	call   801981 <cputchar>
...
cputchar(int ch)
{
  ...
  80198a:	88 45 f7             	mov    %al,-0x9(%ebp)
	...
	sys_cputc(c);
  80198d:	0f be 45 f7          	movsbl -0x9(%ebp),%eax
  801991:	83 ec 0c             	sub    $0xc,%esp
  801994:	50                   	push   %eax
  801995:	e8 ed fa ff ff       	call   801487 <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  8019a3:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8019a6:	e8 a8 fa ff ff       	call   801453 <sys_disable_interrupt>
	char c = ch;
  8019ab:	8b 45 08             	mov    0x8(%ebp),%eax
  8019ae:	88 45 f7             	mov    %al,-0x9(%ebp)
	...
	sys_cputc(c);
  8019b1:	0f be 45 f7          	movsbl -0x9(%ebp),%eax
  8019b5:	83 ec 0c             	sub    $0xc,%esp
  8019b8:	50                   	push   %eax
  8019b9:	e8 c9 fa ff ff       	call   801487 <sys_cputc>
  8019be:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8019c1:	e8 a7 fa ff ff       	call   80146d <sys_enable_interrupt>
}
  8019c6:	90                   	nop
  8019c7:	c9                   	leave  
  8019c8:	c3                   	ret    
...
getchar(void)
{
  ...
  8019cf:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	while(c == 0)
  8019d6:	eb 08                	jmp    8019e0 <getchar+0x17>
	{
		c = sys_cgetc();
  8019d8:	e8 46 f9 ff ff       	call   801323 <sys_cgetc>
...
getchar(void)
{
	...
	int c=0;
	while(c == 0)
  8019e0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  8019e4:	74 f2                	je     8019d8 <getchar+0xf>
	{
		c = sys_cgetc();
	}
	return c;
...
atomic_getchar(void)
{
  ...
  8019ee:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8019f1:	e8 5d fa ff ff       	call   801453 <sys_disable_interrupt>
	int c=0;
  8019f6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	while(c == 0)
  8019fd:	eb 08                	jmp    801a07 <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  8019ff:	e8 1f f9 ff ff       	call   801323 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  801a0b:	74 f2                	je     8019ff <atomic_getchar+0x14>
	{
		c = sys_cgetc();
	}
	sys_enable_interrupt();
  801a0d:	e8 5b fa ff ff       	call   80146d <sys_enable_interrupt>
	return c;
