...
libmain(int argc, char **argv)
{
  ...
  8000bf:	68 bc 19 80 00       	push   $0x8019bc
  ...
  8000e5:	52                   	push   %edx
  8000e6:	50                   	push   %eax
  8000e7:	68 e4 19 80 00       	push   $0x8019e4
  ...
  800116:	52                   	push   %edx
  800117:	50                   	push   %eax
  800118:	68 0c 1a 80 00       	push   $0x801a0c
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002f3:	e8 0c 14 00 00       	call   801704 <__udivdi3>
  ...
  800341:	52                   	push   %edx
  800342:	50                   	push   %eax
  800343:	e8 cc 14 00 00       	call   801814 <__umoddi3>
  800348:	83 c4 10             	add    $0x10,%esp
  80034b:	05 94 1c 80 00       	add    $0x801c94,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80049e:	8b 04 85 b8 1c 80 00 	mov    0x801cb8(,%eax,4),%eax
  ...
  80057f:	8b 34 9d 00 1b 80 00 	mov    0x801b00(,%ebx,4),%esi
  800586:	85 f6                	test   %esi,%esi
  800588:	75 19                	jne    8005a3 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80058a:	53                   	push   %ebx
  80058b:	68 a5 1c 80 00       	push   $0x801ca5
  ...
  80059e:	e9 49 02 00 00       	jmp    8007ec <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8005a3:	56                   	push   %esi
  8005a4:	68 ae 1c 80 00       	push   $0x801cae
  ...
  8005cf:	75 05                	jne    8005d6 <vprintfmt+0x1a6>
				p = "(null)";
  8005d1:	be b1 1c 80 00       	mov    $0x801cb1,%esi
			if (width > 0 && padc != '-')
