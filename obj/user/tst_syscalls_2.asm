...
_main(void)
{
  ...
  800117:	e8 e1 16 00 00       	call   8017fd <env_sleep>
...
libmain(int argc, char **argv)
{
  ...
  8001b8:	68 b8 1b 80 00       	push   $0x801bb8
  ...
  8001de:	52                   	push   %edx
  8001df:	50                   	push   %eax
  8001e0:	68 e0 1b 80 00       	push   $0x801be0
  ...
  80020f:	52                   	push   %edx
  800210:	50                   	push   %eax
  800211:	68 08 1c 80 00       	push   $0x801c08
  ...
  80022c:	50                   	push   %eax
  80022d:	68 60 1c 80 00       	push   $0x801c60
  800232:	e8 18 01 00 00       	call   80034f <cprintf>
  800237:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  80023a:	83 ec 0c             	sub    $0xc,%esp
  80023d:	68 b8 1b 80 00       	push   $0x801bb8
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8003ec:	e8 c3 14 00 00       	call   8018b4 <__udivdi3>
  ...
  80043a:	52                   	push   %edx
  80043b:	50                   	push   %eax
  80043c:	e8 83 15 00 00       	call   8019c4 <__umoddi3>
  800441:	83 c4 10             	add    $0x10,%esp
  800444:	05 94 1e 80 00       	add    $0x801e94,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800597:	8b 04 85 b8 1e 80 00 	mov    0x801eb8(,%eax,4),%eax
  ...
  800678:	8b 34 9d 00 1d 80 00 	mov    0x801d00(,%ebx,4),%esi
  80067f:	85 f6                	test   %esi,%esi
  800681:	75 19                	jne    80069c <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800683:	53                   	push   %ebx
  800684:	68 a5 1e 80 00       	push   $0x801ea5
  ...
  800697:	e9 49 02 00 00       	jmp    8008e5 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  80069c:	56                   	push   %esi
  80069d:	68 ae 1e 80 00       	push   $0x801eae
  ...
  8006c8:	75 05                	jne    8006cf <vprintfmt+0x1a6>
				p = "(null)";
  8006ca:	be b1 1e 80 00       	mov    $0x801eb1,%esi
			if (width > 0 && padc != '-')
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  80180d:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  ...
  801835:	8d 45 e8             	lea    -0x18(%ebp),%eax
  801838:	83 ec 0c             	sub    $0xc,%esp
  80183b:	50                   	push   %eax
  80183c:	e8 cd fc ff ff       	call   80150e <sys_get_virtual_time>
  801841:	83 c4 0c             	add    $0xc,%esp
	while(cycles_counter<time_in_cycles)
  801844:	eb 41                	jmp    801887 <env_sleep+0x8a>
	{
		struct uint64 currentTime = sys_get_virtual_time() ;
  801846:	8d 45 e0             	lea    -0x20(%ebp),%eax
  801849:	83 ec 0c             	sub    $0xc,%esp
  80184c:	50                   	push   %eax
  80184d:	e8 bc fc ff ff       	call   80150e <sys_get_virtual_time>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  80188a:	3b 45 f0             	cmp    -0x10(%ebp),%eax
  80188d:	72 b7                	jb     801846 <env_sleep+0x49>
//				,cycles_counter
//				);
	}
...
uint32 busy_wait(uint32 loopMax)
{
  ...
  801895:	83 ec 10             	sub    $0x10,%esp
	uint32 i = 0 ;
  801898:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
	while (i < loopMax) i++;
  80189f:	eb 03                	jmp    8018a4 <busy_wait+0x12>
  8018a1:	ff 45 fc             	incl   -0x4(%ebp)
  8018a4:	8b 45 fc             	mov    -0x4(%ebp),%eax
  8018a7:	3b 45 08             	cmp    0x8(%ebp),%eax
  8018aa:	72 f5                	jb     8018a1 <busy_wait+0xf>
	return i;
  8018ac:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
  8018af:	c9                   	leave  
  8018b0:	c3                   	ret    
  8018b1:	66 90                	xchg   %ax,%ax
  8018b3:	90                   	nop
