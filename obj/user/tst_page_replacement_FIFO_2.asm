...
//	} ;
  ...
  80010e:	68 c0 1d 80 00       	push   $0x801dc0
  800113:	6a 44                	push   $0x44
  800115:	68 34 1e 80 00       	push   $0x801e34
  ...
  800198:	68 58 1e 80 00       	push   $0x801e58
  80019d:	6a 63                	push   $0x63
  80019f:	68 34 1e 80 00       	push   $0x801e34
  ...
  80024d:	68 a4 1e 80 00       	push   $0x801ea4
  800252:	68 85 00 00 00       	push   $0x85
  800257:	68 34 1e 80 00       	push   $0x801e34
  ...
  800270:	68 34 1f 80 00       	push   $0x801f34
  800275:	68 89 00 00 00       	push   $0x89
  80027a:	68 34 1e 80 00       	push   $0x801e34
  ...
  800293:	68 34 1f 80 00       	push   $0x801f34
  800298:	68 8a 00 00 00       	push   $0x8a
  80029d:	68 34 1e 80 00       	push   $0x801e34
  ...
  8002aa:	68 44 1f 80 00       	push   $0x801f44
...
libmain(int argc, char **argv)
{
  ...
  800325:	68 ac 1f 80 00       	push   $0x801fac
  ...
  80034b:	52                   	push   %edx
  80034c:	50                   	push   %eax
  80034d:	68 d4 1f 80 00       	push   $0x801fd4
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800408:	50                   	push   %eax
  800409:	68 68 20 80 00       	push   $0x802068
  ...
  800421:	50                   	push   %eax
  800422:	68 6d 20 80 00       	push   $0x80206d
  ...
  800446:	68 89 20 80 00       	push   $0x802089
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800475:	68 8c 20 80 00       	push   $0x80208c
  80047a:	6a 26                	push   $0x26
  80047c:	68 d8 20 80 00       	push   $0x8020d8
  ...
  80054a:	68 e4 20 80 00       	push   $0x8020e4
  80054f:	6a 3a                	push   $0x3a
  800551:	68 d8 20 80 00       	push   $0x8020d8
  ...
  8005bd:	68 38 21 80 00       	push   $0x802138
  8005c2:	6a 44                	push   $0x44
  8005c4:	68 d8 20 80 00       	push   $0x8020d8
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800742:	e8 0d 14 00 00       	call   801b54 <__udivdi3>
  ...
  800790:	52                   	push   %edx
  800791:	50                   	push   %eax
  800792:	e8 cd 14 00 00       	call   801c64 <__umoddi3>
  800797:	83 c4 10             	add    $0x10,%esp
  80079a:	05 b4 23 80 00       	add    $0x8023b4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8008ed:	8b 04 85 d8 23 80 00 	mov    0x8023d8(,%eax,4),%eax
  ...
  8009ce:	8b 34 9d 20 22 80 00 	mov    0x802220(,%ebx,4),%esi
  8009d5:	85 f6                	test   %esi,%esi
  8009d7:	75 19                	jne    8009f2 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  8009d9:	53                   	push   %ebx
  8009da:	68 c5 23 80 00       	push   $0x8023c5
  ...
  8009ed:	e9 49 02 00 00       	jmp    800c3b <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8009f2:	56                   	push   %esi
  8009f3:	68 ce 23 80 00       	push   $0x8023ce
  ...
  800a1e:	75 05                	jne    800a25 <vprintfmt+0x1a6>
				p = "(null)";
  800a20:	be d1 23 80 00       	mov    $0x8023d1,%esi
			if (width > 0 && padc != '-')
