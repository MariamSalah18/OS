...
libmain(int argc, char **argv)
{
  ...
  8001ba:	68 34 1e 80 00       	push   $0x801e34
  ...
  800211:	52                   	push   %edx
  800212:	50                   	push   %eax
  800213:	68 84 1e 80 00       	push   $0x801e84
  ...
  80022e:	50                   	push   %eax
  80022f:	68 dc 1e 80 00       	push   $0x801edc
  800234:	e8 01 03 00 00       	call   80053a <cprintf>
  800239:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  80023c:	83 ec 0c             	sub    $0xc,%esp
  80023f:	68 34 1e 80 00       	push   $0x801e34
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80029d:	50                   	push   %eax
  80029e:	68 f0 1e 80 00       	push   $0x801ef0
  ...
  8002b6:	50                   	push   %eax
  8002b7:	68 f5 1e 80 00       	push   $0x801ef5
  ...
  8002db:	68 11 1f 80 00       	push   $0x801f11
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80030a:	68 14 1f 80 00       	push   $0x801f14
  80030f:	6a 26                	push   $0x26
  800311:	68 60 1f 80 00       	push   $0x801f60
  ...
  8003df:	68 6c 1f 80 00       	push   $0x801f6c
  8003e4:	6a 3a                	push   $0x3a
  8003e6:	68 60 1f 80 00       	push   $0x801f60
  ...
  800452:	68 c0 1f 80 00       	push   $0x801fc0
  800457:	6a 44                	push   $0x44
  800459:	68 60 1f 80 00       	push   $0x801f60
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8005d7:	e8 0c 14 00 00       	call   8019e8 <__udivdi3>
  ...
  800625:	52                   	push   %edx
  800626:	50                   	push   %eax
  800627:	e8 cc 14 00 00       	call   801af8 <__umoddi3>
  80062c:	83 c4 10             	add    $0x10,%esp
  80062f:	05 34 22 80 00       	add    $0x802234,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800782:	8b 04 85 58 22 80 00 	mov    0x802258(,%eax,4),%eax
  ...
  800863:	8b 34 9d a0 20 80 00 	mov    0x8020a0(,%ebx,4),%esi
  80086a:	85 f6                	test   %esi,%esi
  80086c:	75 19                	jne    800887 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80086e:	53                   	push   %ebx
  80086f:	68 45 22 80 00       	push   $0x802245
  ...
  800882:	e9 49 02 00 00       	jmp    800ad0 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800887:	56                   	push   %esi
  800888:	68 4e 22 80 00       	push   $0x80224e
  ...
  8008b3:	75 05                	jne    8008ba <vprintfmt+0x1a6>
				p = "(null)";
  8008b5:	be 51 22 80 00       	mov    $0x802251,%esi
			if (width > 0 && padc != '-')
